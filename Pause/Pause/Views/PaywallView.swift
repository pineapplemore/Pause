...
/// Privacy / Terms / Support 等页面部署在 Netlify
private let kLegalBaseURL = "https://bucolic-zuccutto-605ad6.netlify.app"
        ...
        NavigationView {
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    // 5. EULA 与隐私政策链接（3.1.2(c) 要求）- 需可点击且有效
                    VStack(alignment: .leading, spacing: 8) {
                        if let terms = URL(string: kLegalBaseURL + "/terms.html") {
                        ...
                        if let privacy = URL(string: kLegalBaseURL + "/privacy.html") {
